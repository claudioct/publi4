...
namespace Publi4.Models.AccountViewModels
{
    public class UserForCreationViewModel
    {
        ...
        [StringLength(256, MinimumLength = 3, ErrorMessageResourceName = "InvalidStringLength", ErrorMessageResourceType = typeof(Resources.ModelBindingValidationMessages))]
        [Display(Name = "Nome")]
